...
def serializedATN():
    return [
        ...
        0,8,11,5,1,0,0,9,11,5,3,0,0,10,7,1,0,0,0,10,9,1,0,0,0,11,17,1,0,
...
class Expr3Parser ( Parser ):
    ...
    symbolicNames = [ "<INVALID>", "NUM", "IGUAL", "ID", "WS" ]

    RULE_root = 0
    RULE_expr3 = 1

    ruleNames =  [ "root", "expr3" ]
    ...
    class RootContext(ParserRuleContext):
        ...
        def expr3(self):
            return self.getTypedRuleContext(Expr3Parser.Expr3Context,0)
    ...
    class Expr3Context(ParserRuleContext):
        ...
        def expr3(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(Expr3Parser.Expr3Context)
            else:
                return self.getTypedRuleContext(Expr3Parser.Expr3Context,i)


        def IGUAL(self):
            return self.getToken(Expr3Parser.IGUAL, 0)

        def getRuleIndex(self):
            return Expr3Parser.RULE_expr3
    ...
    def expr3(self, _p:int=0):
        ...
        localctx = Expr3Parser.Expr3Context(self, self._ctx, _parentState)
        _prevctx = localctx
        _startState = 2
        self.enterRecursionRule(localctx, 2, self.RULE_expr3, _p)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 10
            ...
            while _alt!=2 and _alt!=ATN.INVALID_ALT_NUMBER:
                if _alt==1:
                    ...
                    _prevctx = localctx
                    localctx = Expr3Parser.Expr3Context(self, _parentctx, _parentState)
    ...
    def sempred(self, localctx:RuleContext, ruleIndex:int, predIndex:int):
        ...
        self._predicates[1] = self.expr3_sempred
